...
\begin{eqnarray}
b_{1}t+b_{2}t^{2}+...+k\left[a_{0}+(a_{1}+b_{1})t+...\right]-\frac{k}{3!}\left[a_{0}+(a_{1}+b_{1})t+(a_{2}+b_{2})t^{2}+...\right]^{3}+...=b_{1}\lambda t+b_{2}\lambda^{2}t^{2}+...
...
\end{eqnarray}
por lo que $a_{0}=0$. Si recordamos, $a_{0},b_{0}$ es el punto fijo. Si ahora usamos los de orden uno en la ecuación \eqref{primer renglon}, \eqref{segundo renglon} respectivamente
\begin{eqnarray}
