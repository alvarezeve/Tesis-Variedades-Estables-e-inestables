...
\include{Capitulo1/preliminares}  % ~15 pag.
\include{Capitulo2/parametrizacion}   
\include{Capitulo3/Henon} 
%\lhead{\begin{picture}(0,0) \put(0,0){\includegraphics[H][width=20mm]{curvas1}} \end{picture}}
\include{Capitulo4/conclusiones-p}     % ~20 páginas - Explicar el problema en específico que se va a resolver, la met   % ~20 páginas - Presentar los resultados tal cual son, y analizarlos.
